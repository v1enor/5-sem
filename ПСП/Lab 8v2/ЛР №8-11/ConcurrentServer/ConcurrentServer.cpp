...
//GarbgaCleaner - поток для очистки мусора
//ConsolePipe - поток для обработки консольных команд
//AcceptServer - поток для принятия новых соединений
//DispathServer - поток для обработки соединений
